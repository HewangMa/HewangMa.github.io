...
namespace test
{
	...
	{
		int a[4][4] =
			{1, 2, 3, 4, 2, 2, 5, 6, 3, 5, 2, 7, 4, 6, 4, 7};
...
void test21()
{
	...
	// copy(num.front(), num.back(), ostream_iterator<int>(cout, " "));
	// cout << endl;
}
